...
export const leagueName = "Frikki Football"; // your league name
...
export const managers = [
  {
      "roster": 1135673631012564992,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Morgan",
    ...
    {
      "roster": 747670372144492544,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Collin",
      // "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Norwalk", // (optional)
      // "bio": "Lorem ipsum",
      // "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
    ...
    {
      "roster": 1005318470814261248,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Dylan",
      // "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
    ...
    {
      "roster": 1130659685620834304,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Julia",
      // "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      // "location": "Brooklyn", // (optional)
      // "bio": "Lorem ipsum...",
    ...
    {
      "roster": 1135673829394952192,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Erin",
      // "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      // "location": "Brooklyn", // (optional)
      // "bio": "Lorem ipsum...",
    ...
    {
      "roster": 1260012642026668032,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Bob",
    //   "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
    //   "location": "Brooklyn", // (optional)
    //   "bio": "Lorem ipsum...",
